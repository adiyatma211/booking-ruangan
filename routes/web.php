...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('booking')->group(function () {
        ...
        Route::get('/', [PagesController::class, 'inquiryRuangan'])->name('booking.index');
        ...
        Route::get('/dashboard/chart-data', [PagesController::class, 'bookingChartData'])->name('dashboard.chart');
        Route::get('/my-bookings/data', [PagesController::class, 'getMyBookings']);
    });
